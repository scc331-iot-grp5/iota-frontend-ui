    ...
    <React.Fragment>
      ...
      >
        ...
        <Select
          ...
          onChange={handleID}
        >
          <MenuItem value={10}>Microbit 1</MenuItem>
          <MenuItem value={20}>Microbit 2</MenuItem>
          <MenuItem value={30}>Microbit 3</MenuItem>
        </Select>
        ...
        <DialogContentText id="alert-dialog-description" variant="h6" sx={{mt:4, mb: 6, minWidth: 120 }}>
      ...
      <IconButton onClick={handleClickOpen} sx={{ml:2 }}>
        ...
        <DialogContentText id="alert-dialog-description" variant="h6" sx={{ mb: 6, mt:4}}>
        <FormControl  sx={{ minWidth: 120 }}>
        ...
        <DialogContentText id="alert-dialog-description" variant="h6" sx={{ mb: 3, mt:4}}>
